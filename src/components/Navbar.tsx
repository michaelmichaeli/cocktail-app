...
export function Navbar() {
  ...
  const isHomePage = location.pathname === "/";
	...
	return (
		<>
			<div className="navbar bg-base-100 border-b shadow-sm sticky top-0 z-40 px-4">
			...
			{!isAddPage && (
				<Link
					to="/add"
					className="fixed top-[calc(4rem+1rem)] right-4 btn btn-secondary btn-circle shadow-lg md:hidden z-50 hover:scale-105 transition-transform"
				>
